        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-6 bg-gradient-to-r from-purple-500 to-purple-600">
            <div className="flex items-center gap-3 text-white">
              ...
              <h3 className="text-xl font-bold">إعداد حساب المدير</h3>
            </div>
          </div>
          ...
          <div className="p-8 space-y-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800">إنشاء حساب المدير الأول</h2>
            
            <p className="text-gray-600 leading-relaxed">
              يبدو أنه لا يوجد حساب مدير في النظام. سيتم إنشاء حساب المدير الأول بالبيانات التالية:
            </p>
            
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-right space-y-2">
              <p className="text-gray-700">
                <strong>البريد الإلكتروني:</strong> 1st.arabcoder@gmail.com
              </p>
              <p className="text-gray-700">
                <strong>كلمة المرور:</strong> Admin@123456
              </p>
              <p className="text-gray-700">
                <strong>المستوى:</strong> مدير
              </p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-semibold text-lg"
              >
                {isSubmitting ? (
                  <>
              ...
              <button
                ...
                className="w-full py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl transition-all duration-200 font-medium"
              >
                إلغاء
              </button>
            </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
            ...
            {/* Admin Setup Button for Login */}
            {mode === 'login' && (
              <button
                type="button"
                onClick={() => setShowAdminSetup(true)}
                className="w-full py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-xl transition-all duration-200 flex items-center justify-center gap-2 font-medium"
              >
