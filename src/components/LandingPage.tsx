        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 mb-6 sm:mb-8 leading-tight">
                <span className="block">الأشراف بني عمير</span>
                <span className="block mt-6 bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">
